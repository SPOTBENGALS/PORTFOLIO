...
export const PROJECTSDATA = [
  ...
  },
  {
    ...
    keyword: ["React", "Typescript", "Emotion", "zustand"],
  },
  {
    id: 3,
  ...
  {
    id: 7,
    projectName: "Public-purpose Info Site",
    descript: "사내 프로젝트에서 php 기반의 HTML/CSS(Bootstrap) 파트를 담당했던 코로나 관련 인포 사이트입니다.",
    image: projectImg07,
    demoLink: "http://jiyeong.dothome.co.kr/pass.php",
    githubLink: "",
    keyword: ["HTML", "Bootstrap"],
  },
];
