...
import projectImg08 from "../images/008.png";
import projectImg09 from "../images/009.png";
...
export const PROJECTSDATA = [
  ...
  },
  {
    ...
    keyword: ["React", "Typescript", "NextJS", "SCSS", "Varcel", "Zustand"],
  },
  {
    id: 4,
  ...
  },
  {
    ...
    descript: "php 기반의 HTML/CSS(Bootstrap) 파트를 담당했던 반응형 사이트입니다.",
    image: projectImg06,
  ...
  },
  {
    ...
    demoLink: "",
    githubLink: "",
    keyword: ["JSP", "Javascript"],
  },
  {
    id: 8,
    projectName: "도시침수 대응 시스템",
    descript: "DT 플랫폼과 React-Query를 활용한 관리자 시스템, 모바일 웹앱 현장 점검 서비스입니다.",
    image: projectImg08,
    demoLink: "",
    githubLink: "",
    keyword: ["React", "Typescript", "Styled-Components", "React-Query", "Zustand", "Vercel", "Thymeleaf"],
  },
  {
    id: 9,
    projectName: "노후계획도시 주민 투표 서비스",
    descript: "국토교통부의 투표 안건 관리 및 투표를 제공하는 서비스입니다.",
    image: projectImg09,
    demoLink: "",
    githubLink: "",
    keyword: ["React", "Typescript", "Styled-Components", "React-Query", "Zustand"],
  },
